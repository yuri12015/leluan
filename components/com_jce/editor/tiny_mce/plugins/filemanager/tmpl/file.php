...
<fieldset><legend><?php echo WFText::_('WF_LABEL_OPTIONS');?></legend>
	...
	<table>
		...
		<tr>
			...
			<td colspan="3">
			<ul id="layout_options_list">
				<li id="layout_option_icon" data-type="icon">
					<label class="label"><?php echo WFText::_('WF_FILEMANAGER_LAYOUT_ICON');?></label>
					<input type="checkbox" id="layout_option_icon_check" />
				</li>
				<li id="layout_option_text" data-type="text">
					<label class="label"><?php echo WFText::_('WF_FILEMANAGER_LAYOUT_TEXT');?></label>
					<input type="checkbox" id="layout_option_text_check" checked="checked" disabled="disabled" />
				</li>
				<li id="layout_option_size" data-type="size">
					<label class="label"><?php echo WFText::_('WF_FILEMANAGER_LAYOUT_SIZE');?></label>
					<input type="text" value="" />
					<input type="checkbox" id="layout_option_size_check" />
					<span role="button" class="layout_option_reload" title="<?php echo WFText::_('WF_FILEMANAGER_LAYOUT_RELOAD');?>"></span>
				</li>
				<li id="layout_option_date" data-type="date">
					<label class="label"><?php echo WFText::_('WF_FILEMANAGER_LAYOUT_DATE');?></label>
					<input type="text" value="" />
					<input type="checkbox" id="layout_option_date_check" />
					<span role="button" class="layout_option_reload" title="<?php echo WFText::_('WF_FILEMANAGER_LAYOUT_RELOAD');?>"></span>
				</li>
			</ul>
			</td>
	...
	<div id="layout_options_disabled"><?php echo WFText::_('WF_FILEMANAGER_OPTIONS_DISABLED');?></div>
</fieldset>