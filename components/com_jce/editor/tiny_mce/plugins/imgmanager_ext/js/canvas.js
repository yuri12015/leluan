	...
	$.widget("ui.canvas", {
		...
		_init : function() {
			...
			if ($.support.canvas) {
				...
				this.canvas 	= Raphael($parent.get(0), w, h);
				this.context	= this.canvas.image($el.attr('src'), 0, 0, w, h);
			}
		...
		getCanvas : function() {
			return this.canvas.raphael ? this.canvas.canvas : this.canvas;
		},
		...
		clear : function() {
			...
			if ($.support.canvas) {
				...
				this.canvas.clear();
				this.context = this.canvas.image($(this.element).attr('src'), 0, 0, w, h);
			}
		},
