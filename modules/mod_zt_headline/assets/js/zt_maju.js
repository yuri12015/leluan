...
var ZTSlideShow5 = new Class({
	...
	initialize:function(options){		
		...
		this.loadingElement = new Element('div').addClass('loadingMaju').injectTop(this.jvSlide); 
        ...
        this.info = new Fx.Morph(this.jvSlide5Info[0], {duration:200});
    ...
    changeItem:function(num){
    	if (this.currentIter != num){
			...
			this.oldSlide = new Fx.Morph(this.jvSlide5Bg[this.currentIter], {duration:this.options.durationSlide5, wait: false});
            this.newSlide = new Fx.Morph(this.jvSlide5Bg[num],{duration:this.options.durationSlide5, wait: false});
            ZTSlideShow5.Transitions[this.options.jvStyleEffect].pass([
                this.oldSlide,
                this.newSlide,
                this.currentIter,
                num], this)();
...
ZTSlideShow5.implement(new Events);
ZTSlideShow5.implement(new Options);

ZTSlideShow5.Transitions = new Hash ({
    fade: function(oldFx, newFx, oldPos, newPos){
        ...
        else
        {
            newFx.set({opacity: 1}).chain(function(){
                this.info = new Fx.Morph(this.jvSlide5Info[newPos], {duration:200});
                this.info.start({'opacity': 1});
            }.bind(this));;
 ...
 * @author jon
 */
ZTSlideShow5.Transitions.extend({
