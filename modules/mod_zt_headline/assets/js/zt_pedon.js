...
var ZTSlideShow8 = new Class({
	...
	initialize:function(options){		
		...
		this.loadingElement = new Element('div').addClass('loadingPedon').injectTop(this.jvSlide); 
    ...
    changeItem:function(num){
    	if (this.currentIter != num){
            ...
            ZTSlideShow8.Transitions[this.options.jvStyleEffect].pass([
                this.oldSlide,
                this.newSlide,
                this.currentIter,
                num], this)();
...
ZTSlideShow8.implement(new Events);
ZTSlideShow8.implement(new Options);

ZTSlideShow8.Transitions = new Hash ({
 ...
 * @author jon
 */
ZTSlideShow8.Transitions.extend({
