...
var ZTSlideShow6 = new Class({
	...
	initialize:function(options){ 		
		...
		this.loadingElement = new Element('div').addClass('loadingSello1').injectTop(this.slideImgContainer); 
		this.loadingElement.setStyles({
			left:this.slideImgContainer.getSize().x/2.2-this.loadingElement.getSize().x/3,
			top:this.slideImgContainer.getSize().y/2.3-this.loadingElement.getSize().y/2
		});
		this.slideImgContainer.removeClass('loading');	
		this.info = new Fx.Morph(this.descItem[0], {duration:300});
        this.info.start({
		'opacity': 1	
		});		
	...
	changeItem:function(num){		
		if (this.currentIter != num){
			...
			this.oldSlide = new Fx.Morph(this.slideImg[this.currentIter], {duration:this.options.slide6transition, wait: false});
            this.newSlide = new Fx.Morph(this.slideImg[num],{duration:this.options.slide6transition, wait: false});
            ZTSlideShow6.Transitions[this.options.styleEffect].pass([
                this.oldSlide,
                this.newSlide,
                this.currentIter,
                num], this)();
            ...
            this.info = new Fx.Morph(this.descItem[num], {duration:300});
...
ZTSlideShow6.implement(new Events);
ZTSlideShow6.implement(new Options);
ZTSlideShow6.Transitions = new Hash ({
 ...
 * @author jon
 */
ZTSlideShow6.Transitions.extend({
