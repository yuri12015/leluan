...
<script type="text/javascript">	
		var jpaneAutoHeight = function(){
		  ...
		  window.addEvent('load',function(){		     		     
				...
				var rowZTScroll = $('jform_params_zt_scroll_thumbs').getParent(); 
				for(i=0;i<=11;i++){
					rowZTScroll.addClass('jv_slide_stylescroll');
					rowZTScroll = rowZTScroll.getNext();
				}
				var rowZTMeda = $('jform_params_zt_meda_thumbs').getParent(); 
				for(i=0;i<=10;i++){ 
					console.log(rowZTMeda);
					rowZTMeda.addClass('jv_slide_stylemeda');
					rowZTMeda = rowZTMeda.getNext();
				}
				...
				var jvScroll = $$('.jv_slide_stylescroll');
				var jvMeda = $$('.jv_slide_stylemeda');
                ...
                switch(style){               
					case "jv_slide1":				
						...
						jvScroll.each(function(item){
							item.setStyle('display','none');
						}); 
						jvMeda.each(function(item){
							item.setStyle('display','none');
						});
					break;
					case "jv_slide2":
