	...
	function getLargeThumbSize($params,&$thumbWidth,&$thumbHeight){
		switch($params->get('layout_style')){			
			...
			case "jv_slide11":
				...
				break;
			case "jv_slide12":
				$thumbHeight = $params->get('zt_scroll_thumb_height');
				$thumbWidth = $params->get('zt_scroll_thumb_width');
				break;
			case "jv_slide13":
	...
	function getSlideContent($params){
		...
		switch ($layoutStyle) {
			...
			case "jv_slide11":	
				...
				break;
			case "jv_slide12":	
				$thumbpath = $params->get('zt_scroll_thumbs');
				break;
			case "jv_slide13":	
				$thumbpath = $params->get('zt_meda_thumbs');
				break;
		}
		if($layoutStyle !='jv_slide2' && $layoutStyle !='jv_slide1' && $layoutStyle!='jv_slide9' && $layoutStyle!='jv_slide10' && $layoutStyle!='jv_slide12' && $layoutStyle!='jv_slide13')
	...
	function getNoItemByStyle($params){
			switch($params->get('layout_style')){
				...
				case "jv_slide11":
					...
					break;
				case "jv_slide12":
					return (int)$params->get('scroll_no_item',6);
					break;
				case "jv_slide13":
					return (int)$params->get('meda_no_item',6);
					break;
				default:
