...
JHTML::_('stylesheet','zt_news.php?id='.$module->id.'&height='.$height,'modules/mod_zt_headline/assets/css/');
$document->addStyleSheet(JURI::base() . 'modules/mod_zt_headline/assets/css/zt_news.css');
$document->addScript(JURI::base() . 'modules/mod_zt_headline/assets/js/zt_news.js'); 
