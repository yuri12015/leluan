...
$document->addStyleSheet(JURI::base() . 'modules/mod_zt_headline/assets/css/slideshow7.css');
$document->addScript(JURI::base() . 'modules/mod_zt_headline/assets/js/slideshow7.js');
...
<script type="text/javascript">
     var startSlideshow<?php echo $moduleId; ?> = function() {
        var mySlideShow7<?php echo $module->id; ?>  = new ZTSlideShow7({
