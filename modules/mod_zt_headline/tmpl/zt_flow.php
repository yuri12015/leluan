...
$document->addStyleSheet(JURI::base() . 'modules/mod_zt_headline/assets/css/zt_flow.css');
$document->addScript(JURI::base() . 'modules/mod_zt_headline/assets/js/zt_flow.js');
...
<div id="zt-slide" style="width: <?php echo $mainWidth;?>px; height: <?php echo $mainHeight;?>px">
	<div class="zt-mainContent" style="height: <?php echo $mainHeight;?>px">
		...
		<div class="zt-content<?php echo $module->id; ?> zt-flowcontent">
	...
	<?php if($shownext>0){?>
	<div id="zt-next" class="zt-next<?php echo $module->id; ?>"> <img src="<?php echo JURI::base();?>modules/mod_zt_headline/assets/images/zt_flow/next.png" alt="next"/> </div>
	<?php }?>
