...
$document->addStyleSheet(JURI::base() . 'modules/mod_zt_headline/assets/css/zt_iner.css');
$document->addScript(JURI::base() . 'modules/mod_zt_headline/assets/js/zt_iner.js');
...
<script type="text/javascript">
    var startSlideshow<?php echo $module->id; ?> = function() {
        var mySlideIner<?php echo $module->id; ?>  = new ZTSlideIner({
            ...
            jvStyleEffect:'<?php echo $params->get('iner_animation'); ?>',
