	...
	<form id='myForm' action="index.php" method="post">
	    ...
	    <?php }else if($item->type=='selected'){
	    	...
	    	?>
				...
				<select  class="inputbox <?php echo $multiple;?>" <?php echo $required; ?> title="<?php echo $item->fieldtitle; ?> Invalid" name="<?php echo $item->fieldname; ?><?php if($item->multi!=0) {?>[]<?php }?>" size="<?php echo $multisize;?>">
