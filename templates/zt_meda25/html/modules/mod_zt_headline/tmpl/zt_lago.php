...
$document->addStyleSheet(JURI::base() . 'modules/mod_zt_headline/assets/css/zt_lago.css');
$document->addScript(JURI::base() . 'modules/mod_zt_headline/assets/js/zt_lago.js');
...
function startSlideshow<?php echo $module->id; ?>() {
    var mySlideshow<?php echo $module->id; ?> = new ZTLagoGallery($('mySlideshow<?php echo $module->id; ?>'), {       
