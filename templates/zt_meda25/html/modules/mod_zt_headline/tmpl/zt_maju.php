...
$document->addStyleSheet(JURI::base() . 'modules/mod_zt_headline/assets/css/zt_maju.css');
$document->addScript(JURI::base() . 'modules/mod_zt_headline/assets/js/zt_maju.js');
...
<script type="text/javascript">
    var startSlideshow<?php echo $module->id; ?> = function() {
        var mySlideShow5<?php echo $module->id; ?>  = new ZTSlideShow5({
                ...
                <div class="jv-proshow-display" style="display:none">
					<?php if($i>1){?>
						<div class="jv_maju_loading">
							<div id="jv_maju_headline<?php echo $module->id;?>_content_<?php echo $i;?>" rel="&lt;img src='<?php echo JURI::root().$item->thumbl; ?>' alt='banner' /&gt;">
								<?php if($item->thumbl) { ?>
									<?php if($enableLink>0){?>
