...
$document->addStyleSheet(JURI::base() . 'modules/mod_zt_headline/assets/css/zt_sello1.css');
$document->addScript(JURI::base() . 'modules/mod_zt_headline/assets/js/zt_sello1.js');
...
<script type="text/javascript">
    var startSlideshow<?php echo $moduleId; ?> = function() {
        var mySlideShow6<?php echo $module->id; ?>  = new ZTSlideShow6({
				...
				<div class="slide_img opaque1" style="opacity:0">
					<?php if($i>1){?>
						<div class="jv_sello1_loading">
							<div id="jv_sello1_headline<?php echo $module->id;?>_content_<?php echo $i;?>" rel="&lt;img src='<?php echo JURI::root().$item->thumbl; ?>' height='<?php echo $imgSlideHeight ?>' width='<?php echo $imgSlideWidth; ?>' alt='image' /&gt;">
								<?php if($enableLink>0){?> 
